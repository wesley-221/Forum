        ...
        <div class = "container extra-padding-top">
            <?php
                ...
                if(isset($_GET['do']))
                {
                    ...
                    if(isset($_GET['f']))
                    {
                        // if do is newthread proceed otherwise invalid thread message
                        if(!strcmp($_GET['do'], "newthread"))
                        {
                            $iGivenForum = $_GET['f'];

                            $qThread = DB::getInstance() -> query('SELECT forumid FROM subforum WHERE subforumid = ?', array($iGivenForum));

                            // check if subforum is valid
                            if($qThread -> count() > 0)
                            {
                                echo '
                                            ...
                                            <tr align = "center">
                                                <td colspan = "2" class = "postinfo">
                                                    <table>
                                                        ...
                                                        <tr>
                                                            <td><input type = "text" name = "subject" class = "form-control" size = "40" tabindex = "1" autofocus /></td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td><textarea cols = "100%" rows = "10" name = "reply_message" tabindex = "2"></textarea></td>
                                                        </tr>';
